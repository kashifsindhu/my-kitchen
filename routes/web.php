...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'admin'], function () {
        ...
        Route::get('/discountpricing/delete/{id}', [DiscountPricing::class, 'destroy'])->name('discountpricing.delete');
        ...
        Route::post('/statestatus', 'StateController@statestatus')->name('state.status');
        Route::get('/getState', 'StateController@getState')->name('state.getdata');
        ...
        Route::group(['prefix' => 'weekelySales', 'middleware' => ['role:Admin']], function () {
            ...
            Route::get('/planned_payment_delete/{id}', 'SaleController@planned_payment_delete')->name('planned_payment_delete');
        });
