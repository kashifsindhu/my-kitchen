                            ...
                            <tr>   
                                ...
                                <tr id="pp_reload">   
                                    ...
                                    Planned Payment                       
                                        ...
                                        <td>
                                            <button id="del_pp_btn" data-id="{{$p->id}}" class="btn btn-danger btn-sm">Delete</button>
                                        </td>
...
@section('scripts')
    <script>
        $(document).ready(function()
        {
            ...
            $(document).on("click", "#del_pp_btn", function(e) 
            {
                e.preventDefault();
                var planpayId = $(this).data("id");
                var element = this;
                Swal.fire({
                    title: "Are you sure?",
                ...
                }).then((result) => 
                {
                    ...
                    {
                        $.ajax({
                            url : "/admin/weekelySales/planned_payment_delete/"+planpayId,
                            type : "GET",
                            success : function(response)
                            {
                                if(response.success)
