...
@section('scripts')
    <!-- <script>
        function toggePassword(){
            var upass = $('#upass').attr('type');
            if(upass == "password")
            {
                $('#upass').css("background-color","green");
                $('#upass').css("color","white");
                $('#upass').attr('type','text');
                $('#toggleBtn').val('Hide Password');
            }
            else
            {
                $('#upass').css("background-color","");
                $('#upass').css("color","");
                $('#upass').attr('type','password');
                $('#toggleBtn').val('Show the password');
            }
        }
    </script> -->
    <script>
