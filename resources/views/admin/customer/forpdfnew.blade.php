                ...
                <div class="form-container pt-4" style="background-color: white;">
                    <div class="row">
                        <div class="main-container border-riht-clr col-lg-6">
                            <div>
                                <h2 class="heading-inner-top" style="padding-left: 10px;">
                                    @isset($customer->delivery_name){{ ucwords($customer->delivery_name) }}@endisset
                                </h2>
                            </div>
                            <div>
                                <div>
                        ...
                        <div class="col-lg-6">
                            <div>
                                ...
                                <div>
                                    <p class="label-wrapper-custm">
                                        Invoice Number: <span>{{$inv_num}}</span>
                                    </p>
                ...
                <div class="row mb-40-wrapper">
                    <div class="col-lg-12">
                        <table class="table table-bordered mb-0" style="width: 100%;">
                            ...
                            <tbody class="week-container-tbl">
                                ...
                                <tr class="week_days_1">
                                    <td class="table-td-wrapper" scope="row" style="background-color: white !important; text-align:center;">
                                        {{ ucwords($product1['name']) }}
                                    </td>
                                    <td style="background-color: white !important; text-align:center;">
                                        <div class="quantity">
                                            {{ $product1['quantity'] }}
                                        </div>
                        ...
                        <table class="table table-bordered mb-0" style="width: 100%;">
                            <tbody class="week-container-tbl">
                                <tr>
                                    <th scope="row" style="width: 44%; text-align: center;">Total Carton</th>
                                    <td scope="row" style="width: 56%; text-align: center;" id="total_ctns">
                                        {{$total}}
                                    </td>
                                </tr>
                            </tbody>
